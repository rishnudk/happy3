  ...
  return (
    <section id="testimonials" className="relative px-4 py-24 md:py-32 overflow-hidden">
      ...
      <div className="mx-auto max-w-7xl relative z-10">
        ...
        >
          <div className="inline-flex items-center gap-1.5 rounded-full border border-white/60 bg-white/40 px-4 py-1.5 text-[11px] font-bold tracking-widest text-[var(--purple-brand)] uppercase shadow-[4px_4px_10px_rgba(165,140,217,0.03),_-4px_-4px_10px_rgba(255,255,255,0.9)]">
            <Star className="h-3 w-3 fill-[var(--purple-brand)] text-[var(--purple-brand)] animate-pulse" />
            Testimonials
          </div>
        ...
        >
          ...
          <button
            onClick={() => scroll("left")}
            className="absolute left-0 top-1/2 z-20 -translate-y-1/2 -translate-x-3 sm:-translate-x-6 h-12 w-12 rounded-full neumorphic-raised flex items-center justify-center text-[var(--purple-brand)] hover:scale-110 active:scale-95 transition-all duration-300 cursor-pointer bg-white/90 border border-white"
          ...
          <button
            ...
            className="absolute right-0 top-1/2 z-20 -translate-y-1/2 translate-x-3 sm:translate-x-6 h-12 w-12 rounded-full neumorphic-raised flex items-center justify-center text-[var(--purple-brand)] hover:scale-110 active:scale-95 transition-all duration-300 cursor-pointer bg-white/90 border border-white"
        ...
        >
          <a
            ...
            className="inline-flex items-center gap-2 rounded-full border border-white/60 bg-white/40 px-6 py-3 text-[14px] font-bold text-[var(--purple-brand)] shadow-[6px_6px_18px_rgba(165,140,217,0.04),_-6px_-6px_18px_rgba(255,255,255,0.9)] hover:shadow-[10px_10px_24px_rgba(165,140,217,0.07),_-10px_-10px_24px_rgba(255,255,255,0.95)] transition-all duration-300 hover:-translate-y-0.5 hover:bg-white/80"
          >
