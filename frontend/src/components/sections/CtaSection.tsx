    ...
    <section id="cta" className="relative px-4 py-24 md:py-32 overflow-hidden">
      <div className="mx-auto max-w-7xl">
        <motion.div
          ...
          className="neumorphic-raised relative overflow-hidden rounded-[40px] px-6 py-12 md:p-16 lg:p-20 border border-white/60 bg-white/45"
        >
          ...
          <div className="relative z-10 grid gap-12 lg:grid-cols-[1.15fr_0.85fr] lg:gap-16 items-center">
            ...
            <div className="flex flex-col items-start text-left">
              <div className="inline-flex items-center gap-1.5 rounded-full border border-white/60 bg-white/40 px-4 py-1.5 text-[11px] font-bold tracking-[0.22em] text-[var(--purple-brand)] uppercase shadow-[4px_4px_10px_rgba(165,140,217,0.03),_-4px_-4px_10px_rgba(255,255,255,0.9)]">
              ...
              <div className="mt-10 flex flex-wrap items-center gap-4 w-full sm:w-auto">
                ...
                <a
                  href="#contact"
                  className="inline-flex items-center justify-center gap-2 rounded-full border border-white/60 bg-white/40 px-8 py-4 text-sm font-semibold text-[var(--nature-black)] shadow-[4px_4px_12px_rgba(165,140,217,0.04),_-4px_-4px_12px_rgba(255,255,255,0.9)] hover:shadow-[8px_8px_18px_rgba(165,140,217,0.07),_-8px_-8px_18px_rgba(255,255,255,0.95)] transition-all duration-300 hover:bg-white/70 hover:-translate-y-0.5 w-full sm:w-auto"
                >
                ...
                {[
                  ...
                  return (
                    <div key={idx} className="flex items-center gap-3">
                      <div className="neumorphic-icon-container flex h-10 w-10 shrink-0 items-center justify-center rounded-xl transition-all duration-300">
            ...
            <div className="relative aspect-[4/4.5] w-full max-w-[420px] mx-auto lg:max-w-none">
              ...
              <div className="glass-surface relative h-full w-full overflow-hidden rounded-[32px] p-2 bg-white/30 backdrop-blur-md shadow-2xl">
                ...
                <motion.div
                  ...
                  className="absolute -left-4 bottom-10 flex items-center gap-2.5 rounded-2xl px-3.5 py-2.5 neumorphic-raised border border-white bg-white/90"
                >
